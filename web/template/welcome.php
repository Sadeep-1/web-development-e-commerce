...
<body>
    <div class="container">
        ...
        <div class="trend">
            ...
            <div class="card">
                <div class="crd">
                    <img src="../images/srt1.webp" alt="" onclick="show(this)">
                    <div class="crdText">
                 ...
                 <div class="crd">
                    <img src="../images/srt2.webp" alt="" onclick="show(this)">
                    <div class="crdText">
                        <h2>Cutton Trending Shirt's</h2>
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
                    ...
                    <div class="crd">
                        <img src="../images/srt6.webp" alt="" onclick="show(this)">
                        <div class="crdText">
                            <h2>Cutton Trending Shirt's</h2>
                            <i class="fa-solid fa-star"></i>
                            <i class="fa-solid fa-star"></i>
                ...
                <div class="trend" id="trendSec">
                    ...
                    <div class="card">
                        <div class="crd">
                            <img src="../images/wn4.webp" alt="" onclick="show(this)">
                            <div class="crdText">
                        ...
                        <div class="crd">
                            <img src="../images/wn5.webp" alt="" onclick="show(this)">
                            <div class="crdText">
                                <h2>Trending Girl Top's</h2>
                            <i class="fa-solid fa-star"></i>
                            <i class="fa-solid fa-star"></i>
                        ...
                        <div class="crd">
                            <img src="../images/wn6.webp" alt="" onclick="show(this)">
                            <div class="crdText">
                                <h2>Trending Girl Top's</h2>
                            <i class="fa-solid fa-star"></i>
                            <i class="fa-solid fa-star"></i>
                ...
                <div class="contact">
                    ...
                    <div class="contactMe">
                        <div class="contactText">
                            ...
                            <p>Contact : online bazzar@gmail.com</p>
                            <p>Number : 98454745757</p>
                        </div>
